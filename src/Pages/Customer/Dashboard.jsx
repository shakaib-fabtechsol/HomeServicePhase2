                    ...
                    <div className='border rounded-xl'>
                        ...
                        <div className='p-3 grid grid-cols-1 gap-4'>
                            {projectStatuses.map((project, index) => (
                                <div key={index} className="flex sm:flex-row flex-col justify-between sm:items-center border p-3 rounded-xl">
                                    <div>
                                        <h5 className="text-[#00000091] text-xs">{project.title}</h5>
                                    </div>
                            ...
                            <div className='flex justify-end mt-4'>
                                <Link className='underline text-[#000] flex items-cneter text-sm gap-x-1'>See Order History <FaArrowRight className="text-xs mt-1"/></Link>
                            </div>
                        </div>
                    </div>
                    <div className='border rounded-2xl p-4'>
                        <h4 className='font-medium text-xl'>Recent Conversations</h4>
                        <Link to="#" className="flex justify-between items-center border p-3 rounded-xl mt-4">
                            <div>
                                <h5 className="text-[#000000] text-sm">5 New messages</h5>
                                <p className='text-[#6E6E6E] text-xs'>Stay connected to the service providers</p>
                            </div>
                            <div>
